...
st.markdown("<h1 style='text-align: center;'>📊 Indicateurs Clés de Performance (KPI)</h1>", unsafe_allow_html=True)
st.write("Cette page présente les indicateurs clés de performance de notre application de suggestion de films.")

# Exemple de données pour les KPI
data_kpi = {
    'KPI': ['Utilisateurs Actifs', 'Films Recommandés', 'Taux de Clics', 'Nouveaux Inscrits'],
...
fig_users = px.line(df_users, x='Mois', y='Utilisateurs', title='Évolution Mensuelle des Utilisateurs')
